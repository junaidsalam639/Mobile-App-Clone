...
const Section02 = () => {
  return (
    <>
      <div className='container mx-auto lg:px-24 md:px-10 sm:px-6 mb-8 xs:px-4'>
        <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2'>
            ...
            <img src="https://technext.github.io/small-apps/images/feature/feature-new-02.jpg" alt="" />               
            </div>
        </div>
      </div>
    </>
